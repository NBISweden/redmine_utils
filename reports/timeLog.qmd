...
params: # Change to fit your query
  ...
  users: [ "André Soares", "Allison Churcher", "Lucile Soler", "Cormac Kinsella", "Mahesh Binzer-Panchal", "Estelle Proux-Wéra", "Guilherme Dias", "Martin Pippel", "Miguel Angel Redondo", "Nikolay Oskolkov", "Per Unneberg", "Tomas Larsson", "Verena Kutschera" ] #[ "John Doe", "Jane Doe" ]
...
if (pixi_env_path != "") {
  ...
  # NOTE: This step is less reliable than using the full path.
  # You need to replace 'your_pixi_env_name' with the actual name or skip this if 'pixi shell' works.
  # reticulate::use_condaenv("your_pixi_env_name", required = TRUE)
