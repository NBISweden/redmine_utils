...
for user in config["users"]: 
  ...
  userTimeLog =  pd.DataFrame.from_dict(redmine.report_time_entries_by_activity_and_month(user_id, config["start_date"], config["end_date"]), orient='index')
...
**Summary of time logging for the period **  (`r paste0($start_date," -- ", config$end_date)`).
