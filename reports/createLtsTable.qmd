...
#py_dir = "{}/.pixi/envs/default/bin/python".format(Path(os.environ["QUARTO_PROJECT_ROOT"]).parent)
#Sys.setenv(RETICULATE_PYTHON="../.pixi/envs/default/bin/python")
library(knitr)
library(reticulate)
...
- *Unfortunately, I did not get filtering on column vals to work on confluence. You have to sort and scroll to get your projects☹️*
...
# make the parent directory available for imports, to be able to import Redmine_apis.py below
import os
import sys
